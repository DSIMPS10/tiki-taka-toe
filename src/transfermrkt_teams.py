...
from data.transfermrkt_api_functions import get_teams_from_season_year
...
def add_teams_to_db_process(season, league_id):
    '''
    ...
    # season = 2019
    team_dict: dict = get_teams_from_season_year(season,league_id)
    team_names_for_season = list(team_dict.keys())
...
def main():
    list_of_seasons = get_list_of_seasons(1992, 2023)
    league_id = 'GB1'
    for season in list_of_seasons:
        teams_added = add_teams_to_db_process(season, league_id)
        print(teams_added)
